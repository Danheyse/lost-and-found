...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if($data) { // if successful login set session variables
		...
		$sessionid = $data['id'];
		Database::disconnect();
		header("Location: lostItems.php?id=$sessionid ");
		// javascript below is necessary for system to work on github
		echo "<script type='text/javascript'> document.location = 'lostItems.php'; </script>";
		exit();
	}
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="login.php" method="post">
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="per_create.php">Join</a>
				</div>
				
				<p> A simple site for hosting lost items </p>
				
				<footer>
					<small>&copy; Copyright 2020, Danel Heyse
					</small>
				</footer>
